...
seed(1337)
max_train = 35000  # max number of tfidf training documents (chosen randomly), for memory efficiency (10-12 GB for 35000)
max_features = 5000
...
sim_dict = {}
batch_size = 200
for i in trange(0, len(pids), batch_size):
